const experiences = [
    {
      ...
      content:'I worked as the back-end developer and responsible for integrating currently availableI worked as the back-end developer and responsible for integrating currently availableI worked as the back-end developer and responsible for integrating currently availableI worked as the back-end developer and responsible for integrating currently availableI worked as the back-end developer and responsible for integrating currently availableI worked as the back-end developer and responsible for integrating currently available apps with Line Bot. Later on, I was also assigned to design the backend APIs for another app made to collect and present files uploaded by students as references and study materials for other students.I worked as the back-end developer and responsible for integrating currently available apps with Line Bot. Later on, I was also assigned to design the backend APIs for another app made to collect and present files uploaded by students as references and study materials for other students.I worked as the back-end developer and responsible for integrating currently available apps with Line Bot. Later on, I was also assigned to design the backend APIs for another app made to collect and present files uploaded by students as references and study materials for other students.'
    },
    {
