const projects = [
    ...
    },
    {
        ...
        content:
            ...
            This project is an actual implementation of SQL comprehension in web developing. \
            Prior to the creation of the front end side of this project, an SQL database was built from scratch - from the tables, relations, data, \
